...
import ShowTestcase from './components/TestCase'
...
document.addEventListener('DOMContentLoaded', () => {
    const testCaseDiv = document.getElementById('testcases');
    if (testCaseDiv) {
        const root = createRoot(testCaseDiv);
        root.render(<ShowTestcase />);
    }
})